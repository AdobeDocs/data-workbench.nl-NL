---
description: Gedetailleerde instructies voor het installeren en configureren van Sensor voor Apache Jakarta Tomcat 4.1 of hoger die worden uitgevoerd onder Windows Server 2000 of hoger.
title: Tomcat-server op Windows Server 2000 of hoger
...
# Tomcat-server op Windows Server 2000 of hoger{#tomcat-server-on-windows-server-or-later}

{{eol}}

Gedetailleerde instructies voor het installeren en configureren van Sensor voor Apache Jakarta Tomcat 4.1 of hoger die worden uitgevoerd onder Windows Server 2000 of hoger.
...
1. Maak op uw Tomcat-server een directory waarin u de Sensor-programmabestanden wilt installeren. Onthoud dat de schijfwachtrij zich in deze map bevindt. Zorg er dus voor dat het apparaat dat u kiest, voldoende ruimte heeft om een wachtrij met de gewenste grootte vast te houden.
...
## Het pad naar de Java-bibliotheek wijzigen {#section-0dae181ef8884f10a57f6cfda8500969}
...
1. Voer Tomcat9w.exe onder de map bin uit (de algemene manager van de daemon-service).
   ...
   Wanneer [!DNL C:\Sensor] is de map die de [!DNL visual_sciences.dll] bestand.
